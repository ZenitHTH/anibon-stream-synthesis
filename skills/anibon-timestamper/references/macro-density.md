...
- **Narrative Chapter Markers**: For long streams (> 6 hours), group chronological timestamp items under inline chapter markers `📌 [ช่วงที่ N: <Narrative Topic>]` inside section blocks so readers can trace the speaker's topic flow from start to end.
